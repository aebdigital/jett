    ...
    <>
      <header className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${scrolled ? "bg-ink/95 shadow-lg shadow-black/30 backdrop-blur" : "bg-transparent"}`}>
        <div className="mx-auto flex h-20 max-w-7xl items-center gap-8 px-5 sm:px-8">
          <a href="#" className="flex items-center" aria-label="JetTransfer — domov">
          ...
          <nav className="ml-auto hidden items-center gap-7 md:flex" aria-label="Hlavná navigácia">
            {LINKS.map((l) => (
